...
- [parameter-types.md](parameter-types.md) - All parameter value types
- [variables.md](variables.md) - Variable references and outputs
- [control-flow.md](control-flow.md) - Conditionals, loops, menus
...
If `plutil` fails with `Unexpected character A at line 1`, the file is an AEA1-signed shortcut (not a raw plist). See [extraction.md](extraction.md) for the complete workflow to extract the readable XML from a signed `.shortcut` file.
